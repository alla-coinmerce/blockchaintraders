...
class KnowledgeBaseNewsArticle extends Model
{
    use HasFactory;
    ...
    protected $fillable = [
        ...
        'bottom_video_poster_original_file_name',
        'bottom_video_poster_storage_path',
    ...
    {
        return $this->hasMany(KnowledgeBaseNewsArticleAttachment::class);
    }
