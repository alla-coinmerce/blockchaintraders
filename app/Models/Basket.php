...
class Basket extends Model
{
     ...
     * 
     */
    public function getTotalParticipationValueInEuroCentsForFund(Basket $fund)
    {
     ...
     */
    public function getParticipationsQtyForFund(Basket $fund)
    {
    ...
    {
        return $this->morphedByMany(Basket::class, 'participant', 'participations')->distinct();
    }
