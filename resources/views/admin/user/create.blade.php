    ...
    <section>
        ...
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <p>
                ...
                <input type="checkbox" id="demo_account" name="demo_account" value="1" @checked(old('demo_account', false)) class="@error('demo_account') is-invalid @enderror">
            ...
            <p>  
                ...
                <input type="radio" id="private" name="registration_type" value="private" @checked(old('registration_type', 'private') === 'private') class="@error('registration_type') is-invalid @enderror">
                <label for="private">Private</label>
                <input type="radio" id="entity" name="registration_type" value="entity" @checked(old('registration_type') === 'entity') class="@error('registration_type') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="firstname" value="{{ old('firstname') }}" class="@error('firstname') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="lastname" value="{{ old('lastname') }}" class="@error('lastname') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="date" name="birthdate" value="{{ old('birthdate') }}" class="@error('birthdate') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="radio" id="yes" name="living_in_netherlands" value="yes" @checked(old('living_in_netherlands', 'yes') === 'yes') class="@error('living_in_netherlands') is-invalid @enderror">
                <label for="yes">Yes</label>
                <input type="radio" id="no" name="living_in_netherlands" value="no" @checked(old('living_in_netherlands') === 'no') class="@error('living_in_netherlands') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="source_of_income" value="{{ old('source_of_income') }}" class="@error('source_of_income') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="taxable_countries" value="{{ old('taxable_countries') }}" class="@error('taxable_countries') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="bsn" value="{{ old('bsn') }}" class="@error('bsn') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="bank_account_number" value="{{ old('bank_account_number') }}" class="@error('bank_account_number') is-invalid @enderror">
            ...
            <p>
                ...
                <input type="text" name="coc_number" value="{{ old('coc_number') }}" class="@error('coc_number') is-invalid @enderror">
            ...
            <p>
                ...
                <textarea name="notes"  class="@error('notes') is-invalid @enderror">{{ old('notes') }}</textarea>
