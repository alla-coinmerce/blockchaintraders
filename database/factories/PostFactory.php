...
class PostFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'featured_img_storage_path' => Storage::putFile('public/posts/images', $img1, 'public'),

            'featured_img_fw_original_file_name' => $img1,
            'featured_img_fw_storage_path' => Storage::putFile('public/posts/images', $img2, 'public'),

            'bottom_img_original_file_name' => $add_bottom_image ? $img3 : '',
            'bottom_img_storage_path' => $add_bottom_image ? Storage::putFile('public/posts/images', $img3, 'public') : '',
